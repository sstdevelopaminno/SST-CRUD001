...
export const NAV_ITEMS: NavItem[] = [
  ...
  { key: "sales-team", href: "/sales-team", permission: "sales:view", featureFlag: "sales-team" },
...
export const DEFAULT_ROLE_PERMISSIONS: Record<SystemRole, PermissionKey[]> = {
  ...
  IT: ["dashboard:view", "it:view", "it:manage", "admin:view", "admin:manage", "approvals:view", "sales:view"],
};
